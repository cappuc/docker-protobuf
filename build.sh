...
--build-arg DART_VERSION="${DART_VERSION:-"2.14.0"}" \
--build-arg GOOGLE_API_VERSION="83bf2aeabf221b6d0bc86b3c671e3c5ad7705747" \
--build-arg GO_VERSION="${GO_VERSION:-"1.17.1"}" \
--build-arg GRPC_GATEWAY_VERSION="${GRPC_GATEWAY_VERSION:-"2.6.0"}" \
--build-arg GRPC_JAVA_VERSION="${GRPC_JAVA_VERSION:-"1.41.0"}" \
--build-arg GRPC_RUST_VERSION="${GRPC_RUST_VERSION:-"0.8.3"}" \
--build-arg GRPC_SWIFT_VERSION="${GRPC_SWIFT_VERSION:-"1.4.1"}" \
--build-arg GRPC_VERSION="${GRPC_VERSION:-"1.41.0"}" \
--build-arg GRPC_WEB_VERSION="${GRPC_WEB_VERSION:-"1.2.1"}" \
--build-arg NODE_VERSION="${NODE_VERSION:-"14.17.6"}" \
...
--build-arg PROTOC_GEN_GO_GRPC_VERSION="${PROTOC_GEN_GO_GRPC_VERSION:-"1.41.0"}" \
--build-arg PROTOC_GEN_GO_VERSION="${PROTOC_GEN_GO_VERSION:-"1.5.2"}" \
...
--build-arg PROTOC_GEN_GQL_VERSION="${PROTOC_GEN_GQL_VERSION:-"0.8.3"}" \
...
--build-arg RUST_PROTOBUF_VERSION="${RUST_PROTOBUF_VERSION:-"2.25.1"}" \
--build-arg RUST_VERSION="${RUST_VERSION:-"1.55.0"}" \
--build-arg SWIFT_VERSION="${SWIFT_VERSION:-"5.5.0"}" \
